...
<div id="slider" class="slider dark">
	<div class="slider-slides cycle-slideshow<?php echo 1 == $query->post_count ? ' one-slide' : '' ?>" data-cycle-pause-on-hover="true" data-cycle-slides=".slide" data-cycle-pager=".slider-pages" data-cycle-timeout="8000" data-cycle-speed="1000" data-cycle-fx="fade">
